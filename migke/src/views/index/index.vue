<template>
    <div class="main">
        <div class="banner"><img src="" alt=""></div>
                    ...
                    <li  v-for="(item,index) in 3" :key="index" class="fadeInUp">
                        ...
                        <div class="business_box" >
                            <div class="business_box_t">
                                <h2>电商平台</h2>
                                <p>MingKeOS帮助企业对接各销售渠道，实现商品，库存，订单，物流，财务等数据的全链路贯通。 OMS拥有作业流程智能设定，可根据企业需求自定义自动化审单流程，灵活的拆单合单规则可满足企业对于复杂订单的处理需求，自动匹配物流方案，全面优化了企业在审单、备货、发货和售后等环节的作业效率。</p>
                            </div>
                            <ul class="business_box_b">
            ...
            <div class="wrapper" >
                <h3 class="content_title fadeInUp zoomIn animated"><span>明科商业智能开放平台MingKeOS</span></h3>
                <h4 class="content_subtitle"><span>为企业搭建供应链信息化平台</span></h4>
                    <ul class="platform_ul">
                        <li v-for="(item,index) in 3" :key="index">
                            <h3><img src="../../img/NicePSD.com.png" alt=""></h3>
                            <h2>自主的可配置平台</h2>
            ...
            <div class="wrapper">
                <h3 class="content_title fadeInUp zoomIn animated"><span>成熟的供应链系统解决方案</span></h3>
                <div class="content programme">
                    <ul class="programme_ul">
                        <li v-for="(item,index) in 12" :key="index">
                            <h3><img src="../../img/programmeTool.png" alt=""></h3>
                            <p>电动工具</p>
                        </li>
                    </ul>
                </div>
            ...
            <div class="content">
                ...
                <div class="content case">
                    <img src="../../img/index_case.png" alt="">
                    <div class="caseContent">
                        <p>基于自动识别技术设计，实现了SAP接口入库、出库、盘点、移位、预警、交叉驳运等业务的精细化管理。采购供货协同
项目物料计划，按需采购，定向配送交叉驳运，自动分拣服务器位于北京总部机房乌兹别克斯坦、俄罗斯跨境实施</p>
                        <div class="loadMoreBtn">
                            <el-button>查看更多</el-button>
                        </div>
                    </div>
...
@media (max-width: 750px) and (min-width: 0){
    ...
    li .business_box{
        display: block;
        background: #fff;
        padding: 0 0.41rem 0.41rem 0.29rem;
    }
    .banner{
    ...
    .platform_ul{
        li{
            ...
            p{
                ...
                color: #363636;
                margin-top: 0.52rem;
                padding: 0 0.41rem 0.79rem 0.29rem;
            }
            img{
                max-height: 2.01rem;
            }
    ...
    .dynamic_ul_card{
        ...
        padding: 0.3rem 0.47rem 1rem 0.3rem;
        h2{
            font-weight: bold;
            font-size: 0.36rem;
            span{
...
.caseContent, .business_box{
    display: none;
}

.business_ul > li:nth-child(2){
    margin: 0 0.62rem;
}
